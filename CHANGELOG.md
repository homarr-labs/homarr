## [1.66.0](https://github.com/homarr-labs/homarr/compare/v1.65.0...v1.66.0) (2026-06-18)

### Features

* add local group support for OIDC users ([#5952](https://github.com/homarr-labs/homarr/issues/5952)) ([fb18b97](https://github.com/homarr-labs/homarr/commit/fb18b975b25b059f9223d4aac13f2e9475b27cc0))
* **beszel:** add error definitions and retry config to beszel widgets ([441cc69](https://github.com/homarr-labs/homarr/commit/441cc692f914497bef9e6f3b4d8aa122a9ff8f80))
* **beszel:** add hover-reveal CSS for system toggle button ([90ceaf5](https://github.com/homarr-labs/homarr/commit/90ceaf5fe87922be52f9feec4dd5a5fbc6edbe1a))
* **beszel:** add searchable system select input for widget options ([ed333e1](https://github.com/homarr-labs/homarr/commit/ed333e1cbbc3dd1a010af8152153df11c83bf68c))
* **beszel:** add SSE subscription endpoint and per-period cache TTL ([c9769bf](https://github.com/homarr-labs/homarr/commit/c9769bf53083147a38c69603fd19933f69d8d06c))
* **beszel:** add translation keys for system stats widget ([5035c26](https://github.com/homarr-labs/homarr/commit/5035c26dbddfef78ef5a1fc873f81ea9c8194f51))
* **beszel:** expose Beszel systems, alerts, and stats via MCP ([8600c63](https://github.com/homarr-labs/homarr/commit/8600c63bab4a1c902f067e22de10e2c97dce876b)), closes [#5968](https://github.com/homarr-labs/homarr/issues/5968)
* **beszel:** wire live SSE streaming for 1-minute time period ([c5266a7](https://github.com/homarr-labs/homarr/commit/c5266a7a42b4c0e92f42827782aae04fbeaf136d))
* **integrations:** add ArchiveTeam Warrior widget ([#5784](https://github.com/homarr-labs/homarr/issues/5784)) ([dd57ee2](https://github.com/homarr-labs/homarr/commit/dd57ee21023f00a2622d90b4638da0e399fe34a3))
* **integrations:** add Gotify notifications integration ([#5847](https://github.com/homarr-labs/homarr/issues/5847)) ([5a1967b](https://github.com/homarr-labs/homarr/commit/5a1967bdd4c1af2b30ff2ddc005516e70d16c1ee)), closes [#4186](https://github.com/homarr-labs/homarr/issues/4186) [#4186](https://github.com/homarr-labs/homarr/issues/4186)

### Bug Fixes

* address PR review findings ([45dfe3b](https://github.com/homarr-labs/homarr/commit/45dfe3b9ab9b95492a15e9411fe9f01e71a1a69f))
* **beszel:** add recovery button when live mode fails ([c5b4cf9](https://github.com/homarr-labs/homarr/commit/c5b4cf9a0e9ea9f35876ab87c4b46722edcd44a7))
* **beszel:** address final review findings ([e29c46c](https://github.com/homarr-labs/homarr/commit/e29c46cc5a9fc105a2923ff409d4989f5b9ae004))
* **beszel:** address review findings for live streaming ([d13effd](https://github.com/homarr-labs/homarr/commit/d13effdda04169b9d7d4aedab0134071bedec5ef))
* **beszel:** correct unit scaling for system stats and container charts ([#5958](https://github.com/homarr-labs/homarr/issues/5958)) ([5fe43eb](https://github.com/homarr-labs/homarr/commit/5fe43eb36329e0db20879cb1ea85264beb35f904))
* **beszel:** deduplicate tooltip entries and round indicator pill ([824f31d](https://github.com/homarr-labs/homarr/commit/824f31d6aaeab5f846eda6a3019471e0a07421b9))
* **beszel:** don't clear live data on transient connection errors ([4a65d2a](https://github.com/homarr-labs/homarr/commit/4a65d2ae87438551aefa45c97aa568aa849876cd))
* **beszel:** improve live subscription error handling and cleanup ([a68eee2](https://github.com/homarr-labs/homarr/commit/a68eee24ebc2f156541d12a6a8436ef333bc8307))
* **beszel:** make chart stacking configurable and fix color mismatch ([82eac2d](https://github.com/homarr-labs/homarr/commit/82eac2dcc10530ad4aff2e993beee6c9b4273aa6))
* **beszel:** MCP description accuracy and type strictness ([420c0c3](https://github.com/homarr-labs/homarr/commit/420c0c30e4f38c6cee25615ad4b5055574344486))
* **beszel:** remove unused {name} placeholder from systemNotFound translation ([7e46c71](https://github.com/homarr-labs/homarr/commit/7e46c711870985c5eaa9b8fa0595005c821b0a0a))
* **beszel:** restore timePeriod cast and improve error visibility ([1609487](https://github.com/homarr-labs/homarr/commit/16094876fab96d633edc08bf01f4391e43aa4530))
* **beszel:** review fixes for MCP and widget styling ([0a05bbe](https://github.com/homarr-labs/homarr/commit/0a05bbed8dd49e42f6cd50fcd27d0f01a4d68770))
* **beszel:** system grid widget respects board opacity and radius ([2a5398b](https://github.com/homarr-labs/homarr/commit/2a5398bec085c16af6cb6ba80867dc65a58c7905)), closes [#5968](https://github.com/homarr-labs/homarr/issues/5968)
* **db:** crash on MySQL — replace onConflictDoNothing with dialect-neutral pre-filter ([#5995](https://github.com/homarr-labs/homarr/issues/5995)) ([f1ee76c](https://github.com/homarr-labs/homarr/commit/f1ee76c99cfb901b762326786aad2b262ad52c88))
* **definitions:** add doc slugs for gotify and archiveTeamWarrior ([5f588ae](https://github.com/homarr-labs/homarr/commit/5f588ae28780ecbed2e774507ab3f49a03d027a5))
* **deps:** update dependency postcss to ^8.5.15 ([#5940](https://github.com/homarr-labs/homarr/issues/5940)) ([85e7469](https://github.com/homarr-labs/homarr/commit/85e74691f272941ebee480696a74b77ffe97eed2))
* **docs:** use valid string type for beszel system stats config ([ece436a](https://github.com/homarr-labs/homarr/commit/ece436a1ccb0c2f747644552764db3cb94e19f73))
* fixes and unifies descriptions in dns-hole-controls and dns-hole-summary docs ([#5938](https://github.com/homarr-labs/homarr/issues/5938)) ([6881b83](https://github.com/homarr-labs/homarr/commit/6881b8355c7e940360a0fb582787f0a770430c5b))
* **integrations:** make Emby Studios field optional ([#5997](https://github.com/homarr-labs/homarr/issues/5997)) ([6960ac1](https://github.com/homarr-labs/homarr/commit/6960ac15e9910a2716d002e85c9ed8cb933ba613))
* make quicklook optional in Glances integration schema ([#5949](https://github.com/homarr-labs/homarr/issues/5949)) ([58058f2](https://github.com/homarr-labs/homarr/commit/58058f2ea6a67259676228f7f791230b0e33f57a)), closes [#5728](https://github.com/homarr-labs/homarr/issues/5728)
* persist Beszel server selection and improve picker visibility ([#5985](https://github.com/homarr-labs/homarr/issues/5985)) ([445e191](https://github.com/homarr-labs/homarr/commit/445e191490ba0115150c39ba69469b9860569133))
* **ui:** prevent icon/name wrapping in custom widgets table ([3990009](https://github.com/homarr-labs/homarr/commit/39900090b3b83e112169ecbd2f319e4cf5b41a50))
* **widgets:** prevent TabsContainer state reset on data refetch ([065b78f](https://github.com/homarr-labs/homarr/commit/065b78fa3e89d4b8a13d8889232943a3686989e4))
* **widgets:** race conditions in useLiveStats and stale value in integration select ([5078c30](https://github.com/homarr-labs/homarr/commit/5078c300f824029450db9ad25418af770626d60e))

### Performance Improvements

* **beszel:** deep memoization pass for live chart rendering ([8134b16](https://github.com/homarr-labs/homarr/commit/8134b168e162fa3f0ab2a44a40136531aa5a85f4))
* **beszel:** fix live mode re-render cascade for Docker charts ([6189daf](https://github.com/homarr-labs/homarr/commit/6189daf6a42aa7d0a270d7efa4d2be6f4106b71e))
* **beszel:** throttle live renders, reduce buffer, skip hidden charts ([9abce89](https://github.com/homarr-labs/homarr/commit/9abce89a142df7467bfa5c1e04529637159fb38d))
