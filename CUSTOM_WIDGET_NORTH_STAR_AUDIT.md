...
| Runtime display bindings                | [`custom-jsx-display.tsx`](packages/widgets/src/custom-api/custom-jsx-display.tsx)                                                                                                                                                                                                  | Template change state clearing and fresh data/status wrapper objects.                                                                                                                      |
| Prompt and channel contract             | [`ai-prompt.ts`](packages/custom-widgets/src/core/ai-prompt.ts), [`_copy-ai-prompt-button.tsx`](apps/nextjs/src/app/[locale]/manage/custom-widgets/_copy-ai-prompt-button.tsx), and [`assistant-tool-policy.ts`](apps/nextjs/src/app/api/assistant/chat/assistant-tool-policy.ts)   | Clipboard final-output instruction conflicts with the in-product tool lifecycle.                                                                                                           |
