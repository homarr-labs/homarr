...
![Version: 5.11.0](https://img.shields.io/badge/Version-5.11.0-informational?style=flat)
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat)
![AppVersion: v1.37.0](https://img.shields.io/badge/AppVersion-v1.37.0-informational?style=flat)
...
| image.tag | string | `"v1.37.0"` | Overrides the image tag whose default is the chart appVersion |
