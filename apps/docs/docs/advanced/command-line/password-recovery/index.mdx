...
![Reset-password command help showing that username is required](./img/screenshot-cli.png)
...
![Terminal output confirming a password reset and session deletion](./img/screenshot-cli-result.png)
