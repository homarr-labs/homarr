...
The demo board includes every available widget kind. Integration-backed widgets use the bundled mock integration, while network or media examples use deterministic demo-safe sources where possible.
