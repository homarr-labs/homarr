    ...
    items: [
      {
        name: "Website",
        description:
          "Select a website tracked by your Umami instance. Populated automatically from the connected integration.",
      ...
      },
      {
        name: "Chart style",
        description:
          'How to render the event series alongside visitors. Visible when View is "Chart", Chart type is "Bar chart", and an Event is selected.',
        values: {
          type: "select",
      ...
      },
      {
        name: "Event",
        description:
          'Overlay a single named event on the visitor chart. Populated from event names recorded by Umami. Visible when View is "Chart".',
      ...
      },
      {
        name: "Events",
        description:
          'Select one or more events to plot as individual series with no visitors baseline. Populated from event names recorded by Umami. Visible when View is "Events chart".',
