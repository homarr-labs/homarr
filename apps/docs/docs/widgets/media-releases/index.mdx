...
The Media releases widget shows newly added media or upcoming releases with their source, date, artwork, and configured
metadata. Advanced view adds descriptions and tags. Healthy integrations remain visible when another source fails.
...
<div className="flex gap-1">
  <img src={backdrop.src} alt="media-releases layout-backdrop" width={256} />
  <img src={poster.src} alt="media-releases layout-poster" width={256} />
</div>
