...
Gauges switch to a smaller layout when the visible widget is narrow or short, including when fitting more columns or resizing the browser. Gauge labels stay proportional as the board scales.
