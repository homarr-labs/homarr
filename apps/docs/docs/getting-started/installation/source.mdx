...
<ol>
  ...
  <li>
    Copy the `.env.example` file to `.env` and replace `DB_URL` with the full path you want to use for the sqlite
    database file. For example `DB_URL='/home/username/homarr/db.sqlite`
  </li>
  <li>
