...
<Link
  data-attr="Install Unraid Community Apps"
...
![Unraid navigation with the Apps tab highlighted](img/unraid-navigation-app-manager.webp)
:::
...
![Homarr result in Unraid Community Apps with installation actions](img/unraid-apps-homarr.webp)
