...
- [Docker Compose](https://docs.docker.com/compose/install/) - _preinstalled on many systems nowadays_
...
- Delete the old image using `docker image prune` (_Warning: this also removes you other unused images - not just Homarr_)
...
- Prune unused Docker images using `docker image prune` (_Warning: this also removes you other unused images - not just Homarr_)
...
3. Prune unused Docker images using `docker image prune` (_Warning: this also removes you other unused images - not just Homarr_)
