...
keep its advanced view open until you close it. Widgets without a distinct advanced experience adapt in place. If you
can change the board, right-click empty grid space to add an item at that position.
