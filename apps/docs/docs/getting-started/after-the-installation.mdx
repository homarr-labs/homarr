...
Use the category menu to open every app in that category in new tabs, or use the board header action to open every app on the current board layout in new tabs.
