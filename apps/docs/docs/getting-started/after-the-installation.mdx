...
The side editor keeps the selected tile visible while you choose the app and adjust its display settings:

<figure>
  <img
    src={editItemCurrent}
    alt="App tile highlighted beside the Edit item side editor"
    style={{ maxWidth: "620px" }}
  />
  <figcaption>The selected tile stays highlighted while the rest of the board is subdued.</figcaption>
</figure>
