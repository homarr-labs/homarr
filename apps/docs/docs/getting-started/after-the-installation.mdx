...
import layoutSettingsCurrent from "./img/onboarding-layout-settings-current.png";
...
<figure>
  <img
    src={layoutSettingsCurrent}
    alt="Board Settings Layout section showing independent Mobile and Base layout cards"
    style={{ maxWidth: "100%" }}
  />
  <figcaption>
    Mobile and Base are protected layouts inside the same board; each keeps its own positions and sizes.
  </figcaption>
</figure>
