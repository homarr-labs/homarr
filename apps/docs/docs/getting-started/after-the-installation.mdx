...
<img
  src={imageStartFromScratchStepAdminUser}
  alt={"Screenshot form to create admin user"}
  width={300}
/>
...
<img
  src={imageStartFromScratchStepFinish}
  alt={"Screenshot of the finish onboarding process with links"}
  width={300}
/>
...
<img
  src={manageExportOldHomarr}
  alt="Export from old Homarr"
  style={{ maxWidth: 500 }}
/>
...
<img
  src={manageBoardHeaderEditMode}
  alt={"Screenshot of buttons in the edit mode"}
  width={200}
/>
...
<img
  src={manageBoardHeaderAddItem}
  alt={"Screenshot of the add item menu"}
  width={200}
/>
...
<img
  src={manageBoardHeaderChooseItem}
  alt={"Screenshot of choosing the app item in the modal"}
  width={300}
/>
...
<img
  src={manageBoardNoApp}
  alt="Screenshot of the No app element on the board"
/>
...
Dynamic sections normally shrink their items to keep everything visible inside the section's
current size. If you'd rather keep items at their natural size and scroll to see the rest, open
the section's settings (the menu in its top-right corner while in edit mode) and turn on
**Scrollable**. This is off by default.
