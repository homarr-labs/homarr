...
<IntegrationHeader integration={peaNutIntegration} categories={["UPS", "Hardware"]} />
...
<IntegrationSecrets
  secrets={[
    ...
    {
      credentials: [],
      steps: ["If PeaNUT runs with AUTH_DISABLED=true, create the integration with no credentials."],
    },
  ]}
/>
