  ...
  secrets={[
    {
      ...
      header: (
        <Alert type="info">
          This integration does not require full API access to the firewall. The following guide outlines the process
          for creating a restricted OPNsense user with a scrambled password, designed exclusively for API access. This
          ensures minimal permissions and prevents local login capability.
        </Alert>
      ),
      steps: [
