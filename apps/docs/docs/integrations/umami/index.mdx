...
<IntegrationHeader integration={umamiIntegration} categories={["Analytics"]} />

### Widgets & Capabilities

<IntegrationCapabilites items={[{ widget: umamiWidget }]} />

### Adding the integration

<AddingIntegration />

<Alert type="tip" title="URL configuration">
