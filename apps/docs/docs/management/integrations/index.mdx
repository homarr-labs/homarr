...
A missing native feature does not mean the integration cannot do it. If the service exposes an API endpoint, an agent
can consult its API docs and test the request through [`integration_request`](../mcp#authenticated-integration-requests),
