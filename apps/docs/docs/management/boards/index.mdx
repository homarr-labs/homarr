...
Collapsing a Container reduces it to a half-row expansion pill and compacts the surrounding layout without losing its expanded size.
Expanding it restores those bounds and moves following items out of the way.
