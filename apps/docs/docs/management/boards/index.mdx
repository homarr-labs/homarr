...
Pointer users can drag anywhere on a tile; the grip is a visual cue for that move surface rather than a separate control.
...
Collapsing a Container compacts the surrounding layout without losing its expanded size.
