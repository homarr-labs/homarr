...
Homarr can display a background image or video behind apps and widgets.
This URL can be used to define what media should be shown.
Uploaded MP4 and WebM videos can be selected from the local media picker.
