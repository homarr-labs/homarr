...
All board settings are edited on a single page. Click the **Save changes** button in the save bar at the bottom to apply them. The save bar only appears when you have unsaved changes.
