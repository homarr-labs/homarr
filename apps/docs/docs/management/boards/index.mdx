...
Widgets choose compact layouts from their visible size, including scaling inside nested Containers. Text and controls
retain readable sizing as the board shrinks; opening a widget's advanced view uses the available space in that view.
