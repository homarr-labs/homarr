...
Spotlight. It lists the available actions directly and can add a widget, app, integration, Container, board, Workshop item, or Custom Widget when the
...
<img
  src={keyboardTileEditingImage}
  alt="A focused board tile in keyboard editing mode"
  style={{ maxWidth: "100%" }}
/>
