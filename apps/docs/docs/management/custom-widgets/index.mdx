...
Custom Widgets supports [trusted widget packages](./trusted-packages) with full TSX, CSS, modules, optional Node
handlers, and advanced views, alongside the restricted v2 authoring format. Both can work without an API.

A **v2 Custom Widget** is a validated `homarr-custom-widget-v2` definition containing optional API sources, queries and actions,
...
- [Build a trusted widget package](./trusted-packages), configure local connections, and manage its Workshop releases.
