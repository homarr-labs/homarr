...
### Statistics and 32 new integrations
...
- **Monitoring and networking:** Caddy, Changedetection.io, Frigate, Gatus, Healthchecks, MySpeed, NetAlertX, Netdata, Prometheus, Scrutiny and Syncthing Relay.
