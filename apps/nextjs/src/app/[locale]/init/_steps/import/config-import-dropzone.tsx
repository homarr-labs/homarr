...
interface ConfigImportDropZoneProps {
  loading: boolean;
  updateFile: (file: FileWithPath) => void;
}

export const ConfigImportDropZone = ({ loading, updateFile }: ConfigImportDropZoneProps) => {
  const tDropzone = useScopedI18n("init.step.import.configDropzone");
  return (
    <Dropzone
      onDrop={(files) => {
