...
import { Alert, Button, Checkbox, Group, Modal, Radio, Stack, Stepper } from "@mantine/core";
...
export const RestoreBackupButton = () => {
  ...
  const { fileContent, validation, isPending, handleFileDrop, reset } = useBackupFileValidation({
    validateMutation,
  });
  ...
  }, [fileContent, restore, mode, createBackupFirst]);
