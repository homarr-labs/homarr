...
import { integrationCreateFieldsSchema, requiresInsecureHttpOptIn } from "@homarr/validation/integration";
...
const formSchema = integrationCreateFieldsSchema.omit({ kind: true, app: true }).and(
  z.object({
    hasApp: z.boolean(),
