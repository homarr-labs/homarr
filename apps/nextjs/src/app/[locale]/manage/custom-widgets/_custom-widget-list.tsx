...
import { Avatar, Badge, Button, Group, Text, Tooltip } from "@mantine/core";
...
function CustomWidgetRow({ widget }: { widget: WidgetDef }) {
  ...
  return (
    <ManageCollectionItem
      ...
      badges={<CustomWidgetStatusBadges widget={widget} />}
      description={
...
function CustomWidgetStatusBadges({ widget }: { widget: WidgetDef }) {
  const t = useScopedI18n("customWidget");
    ...
    <Group gap={6} wrap="nowrap">
      ...
      {widget.missingSecrets.length > 0 && (
        <Tooltip
          ...
          maw={320}
        >
          <Badge color="yellow" size="sm" variant="light" leftSection={<IconAlertTriangle size={12} />}>
