        ...
        {credentialInputsVisible && (
          <>
            <form onSubmit={form.onSubmit((credentials) => void signInAsync(credentials.provider, credentials))}>
              <Stack gap="lg">
                <TextInput label={t("field.username.label")} autoComplete="username" {...form.getInputProps("name")} />
                <PasswordInput label={t("field.password.label")} autoComplete="current-password" {...form.getInputProps("password")} />
