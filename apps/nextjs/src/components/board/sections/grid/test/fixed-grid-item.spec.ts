...
describe("fixed grid item behavior", () => {
  ...
  test("uses the whole tile as the focusable move surface without a grab button", () => {
    ...
    expect(container.querySelector('[data-testid="board-grid-drag-handle"]')).toBeNull();
  });
