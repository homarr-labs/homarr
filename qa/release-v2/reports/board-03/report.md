<!-- release-v2-qa-report
{
  ...
  "status": "blocked",
  "caseStatuses": {
    "BD-003-THRESHOLDS": "blocked",
    "BD-003-MUTATION": "blocked",
    "BD-003-PERSISTENCE": "blocked",
    "BD-003-ACCESS-RECOVERY": "blocked"
  },
  "execution": {
    ...
    "persona": "Casey Chaos",
    "sessionId": "qa-v2-board-03",
    "timestamp": "2026-08-31T15:34:27.703Z",
  ...
  "findings": [
    {
      ...
      "caseIds": [
        ...
        "BD-003-MUTATION",
        "BD-003-PERSISTENCE",
        "BD-003-ACCESS-RECOVERY"
      ],
      "evidence": [
        "/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03/BD-003-redirect-retry.png",
        "/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03/redirect-first.png"
      ]
    }
  ],
  "artifacts": [
...
| Chromium viewports | tablet-1024, desktop-1440 |
| Zoom | 100%, 125% |
...
| Browser session ID | qa-v2-board-03 |
| Timestamp | 2026-08-31T15:34:27.703Z |
...
| --- | --- | --- | --- | --- |
| BD-003-THRESHOLDS | blocked | [browser artifacts](/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03) | The application entry repeated redirects until Chromium stopped navigation; the assigned flow was not reachable. | Exercise every assigned viewport, zoom, and input, including breakpoint and dense-layout stress. |
| BD-003-MUTATION | blocked | [browser artifacts](/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03) | The application entry repeated redirects until Chromium stopped navigation; the assigned flow was not reachable. | Exercise create, move, resize, reorder, collapse, and delete paths that apply to this packet. |
| BD-003-PERSISTENCE | blocked | [browser artifacts](/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03) | The application entry repeated redirects until Chromium stopped navigation; the assigned flow was not reachable. | Reload, switch layouts or sessions, and verify saved and reset state remains correct. |
| BD-003-ACCESS-RECOVERY | blocked | [browser artifacts](/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03) | The application entry repeated redirects until Chromium stopped navigation; the assigned flow was not reachable. | Verify Owner, Editor, Viewer, outsider, read-only, keyboard, cancellation, error, and recovery behavior that applies. |
...
Preconditions: candidate f57a660088d6777c86aca22977354fa8b810e2be, main-writable, tablet-1024, 100% zoom, mouse, fresh named Chromium session qa-v2-board-03.
...
- [BD-003-redirect-retry.png](/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03/BD-003-redirect-retry.png)
- [redirect-first.png](/home/habs/.codex/worktrees/8ba8/homarr/.screenshots/release-v2/board-03/redirect-first.png)
