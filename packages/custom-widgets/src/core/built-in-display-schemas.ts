...
export const singleValueDisplayConfigSchema = z.object({
  type: z
    .literal("singleValue")
...
export const keyValueDisplayConfigSchema = z.object({
...
export const statGridDisplayConfigSchema = z.object({
...
export const progressBarsDisplayConfigSchema = z.object({
  type: z
...
export const statusIndicatorDisplayConfigSchema = z.object({
  type: z
...
export const countGridDisplayConfigSchema = z.object({
  type: z
    .literal("countGrid")
...
export const rawDisplayConfigSchema = z.object({
