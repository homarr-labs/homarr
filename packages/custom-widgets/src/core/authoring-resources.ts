...
import {
  ...
  CUSTOM_WIDGET_SKILL_VERSION,
} from "./embedded-ai-prompt";
...
export function getCustomWidgetSkill() {
  return {
    ...
    files: CUSTOM_WIDGET_SKILL_FILES,
    componentCatalog: customJsxAuthoringCatalog,
    examples: customJsxExamples,
...
export function getCustomWidgetOfflineBundle() {
  return CUSTOM_WIDGET_OFFLINE_BUNDLE;
}
