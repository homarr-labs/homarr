...
export type SettingsContextProps = Pick<
  User,
  "firstDayOfWeek" | "defaultSearchEngineId" | "homeBoardId" | "mobileHomeBoardId" | "openSearchInNewTab" | "pingIconsEnabled"
> &
...
export interface PublicServerSettings {
  ...
  board: Pick<ServerSettings["board"], "homeBoardId" | "mobileHomeBoardId" | "enableStatusByDefault" | "forceDisableStatus">;
}
...
export const createSettings = ({ user, serverSettings }: { user: UserSettings | null; serverSettings: PublicServerSettings }) => ({
