...
import {Integration, IntegrationInput, IntegrationTestingInput} from "../base/integration";
import {dawarichPlacesSchema, dawarichStatisticsSchema} from "./dawarich-schemas";
import {z} from "zod/v4";
import {TestingResult} from "../base/test-connection/test-connection-service";
