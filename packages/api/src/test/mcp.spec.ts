...
const MCP_TOOL_ALLOWLIST = {
  query: [
    ...
    "customWidget_list",
    "customWidget_package_checkUpdate",
    "customWidget_package_get",
    "customWidget_package_list",
    "customWidget_package_workshopRelease",
    "customWidget_package_workshopReleases",
  ...
  mutation: [
    ...
    "customWidget_delete",
    "customWidget_package_activate",
    "customWidget_package_preview",
    "customWidget_package_saveDraft",
    "customWidget_package_setEnabled",
