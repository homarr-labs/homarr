...
const moduleLoaders: Record<WidgetKind, () => Promise<WidgetModule>> = {
  ...
  komodo: () => import("./komodo") as Promise<WidgetModule>,
  komodoServerOverview: () => import("./komodo-server-overview") as Promise<WidgetModule>,
...
const componentLoaders: Record<WidgetKind, () => Promise<WidgetComponentModule>> = {
  ...
  komodo: () => import("./komodo/component") as Promise<WidgetComponentModule>,
  komodoServerOverview: () => import("./komodo-server-overview/component") as Promise<WidgetComponentModule>,
