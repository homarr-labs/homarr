    ...
    return optionsBuilder.from(
      (factory) => ({
        ...
        descriptionDisplayMode: factory.select({
          options: [
            { value: "normal", label: (t: (s: string) => string) => t("widget.app.option.descriptionDisplayMode.option.normal") },
            { value: "tooltip", label: (t: (s: string) => string) => t("widget.app.option.descriptionDisplayMode.option.tooltip") },
            { value: "hidden", label: (t: (s: string) => string) => t("widget.app.option.descriptionDisplayMode.option.hidden") },
          ] as const,
        ...
        layout: factory.select({
          options: [
            ...
            { value: "column-reverse", label: (t: (s: string) => string) => t("widget.app.option.layout.option.column-reverse") },
            { value: "row", label: (t: (s: string) => string) => t("widget.app.option.layout.option.row") },
            { value: "row-reverse", label: (t: (s: string) => string) => t("widget.app.option.layout.option.row-reverse") },
          ] as const,
