...
describe("Umami layout", () => {
  test.each([
    ...
    { width: 100, height: 80, property: "showXAxis" as const, expected: false },
    { width: 100, height: 80, property: "showSecondaryStats" as const, expected: false },
    { width: 100, height: 80, property: "showDetailedStats" as const, expected: false },
