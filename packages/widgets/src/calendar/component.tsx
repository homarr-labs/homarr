...
export default function CalendarWidget({ isEditMode, itemId, integrationIds }: WidgetComponentProps<"calendar">) {
  const [events] = clientApi.widget.calendar.findAllEvents.useSuspenseQuery(
    {
      // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
      itemId: itemId!, // TODO: this should obviously not be a required option
      integrationIds,
    },
    {
