...
export const nativeFeatureCapabilities = {
  ...
  "smartHome-entityState": { integrations: getIntegrationKindsByCategory("smartHomeServer") },
  "smartHome-executeAutomation": { integrations: getIntegrationKindsByCategory("smartHomeServer") },
  ...
  mediaTranscoding: { integrations: getIntegrationKindsByCategory("mediaTranscoding") },
  ...
  "immich-serverStats": { integrations: ["immich"] },
  "immich-albumCarousel": { integrations: ["immich"] },
  paperlessNgx: { integrations: ["paperlessNgx"] },
  patchmon: { integrations: ["patchmon"] },
  bazarr: { integrations: ["bazarr"] },
