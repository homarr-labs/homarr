...
import { MRT_Localization_HU } from "mantine-react-table/locales/hu/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_HU as Readonly<Record<keyof typeof MRT_Localization_HU, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "A lejárat után a meghívó már nem lesz érvényes, és a meghívó címzettje nem tud fiókot létrehozni.",
            },
            copy: {
              link: "Meghívó link",
            },
            delete: {
              ...
              description:
                "Biztos, hogy törölni szeretné ezt a meghívót? Az ezzel a linkkel rendelkező felhasználók többé nem tudnak fiókot létrehozni a link használatával.",
            },
          },
          field: {
            id: {
