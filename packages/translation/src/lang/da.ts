...
import { MRT_Localization_DA } from "mantine-react-table/locales/da/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_DA as Readonly<Record<keyof typeof MRT_Localization_DA, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Efter udløb vil en invitation ikke længere være gyldig, og modtageren af invitationen vil ikke være i stand til at oprette en konto.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Er du sikker på, at du vil slette denne invitation? Brugere med dette link vil ikke længere kunne oprette en konto ved hjælp af dette link.",
            },
          },
          field: {
            id: {
