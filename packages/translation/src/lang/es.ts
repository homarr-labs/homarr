...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_ES as Readonly<Record<keyof typeof MRT_Localization_ES, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Después de la caducidad, una invitación ya no será válida y el destinatario de la invitación no podrá crear una cuenta.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "¿Estás seguro de que deseas eliminar esta invitación? Los usuarios con este enlace ya no podrán crear una cuenta usando ese enlace.",
            },
          },
          field: {
            id: {
