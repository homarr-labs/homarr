...
import { MRT_Localization_PT } from "mantine-react-table/locales/pt/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_PT as Readonly<Record<keyof typeof MRT_Localization_PT, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Após a expiração, um convite não será mais válido e o destinatário do convite não poderá criar uma conta.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Tem certeza de que deseja excluir este convite? Os usuários com esse link não poderão mais criar uma conta usando esse link.",
            },
          },
          field: {
            id: {
