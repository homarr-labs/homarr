...
import { MRT_Localization_CS } from "mantine-react-table/locales/cs/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_CS as Readonly<Record<keyof typeof MRT_Localization_CS, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Po vypršení platnosti pozvánka přestane být platná a příjemce pozvánky si nebude moci vytvořit účet.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Jste si jisti, že chcete tuto pozvánku smazat? Uživatelé s tímto odkazem již nebudou moci pomocí tohoto odkazu vytvořit účet.",
            },
          },
          field: {
            id: {
