...
import { MRT_Localization_ZH_HANT } from "mantine-react-table/locales/zh-Hant/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_ZH_HANT as Readonly<Record<keyof typeof MRT_Localization_ZH_HANT, string>>,
  },
  section: {
    category: {
      field: {
