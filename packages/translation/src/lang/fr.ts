...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_FR as Readonly<Record<keyof typeof MRT_Localization_FR, string>>,
  },
  section: {
    category: {
      field: {
  ...
  widget: {
    ...
    iframe: {
      name: "iFrame",
      description:
        "Intégrer n'importe quel contenu à partir d'Internet. Certains sites Web peuvent restreindre l'accès.",
      option: {
        embedUrl: {
          label: "URL intégrée",
        },
  ...
  board: {
    ...
    field: {
      ...
      customCss: {
        description:
          "En outre, vous pouvez personnaliser votre tableau de bord à l'aide de CSS. Réservé aux utilisateurs expérimentés.",
      },
      name: {
        label: "Nom",
      },
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Après expiration, une invitation ne sera plus valide et le destinataire de cette invitation ne pourra pas créer un compte.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Êtes-vous sûr de vouloir supprimer cette invitation ? Les utilisateurs avec ce lien ne pourront plus créer un compte avec ce dernier.",
            },
          },
          field: {
            id: {
