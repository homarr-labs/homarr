...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_VI as Readonly<Record<keyof typeof MRT_Localization_VI, string>>,
  },
  section: {
    category: {
      field: {
  ...
  board: {
    ...
    field: {
      ...
      customCss: {
        description:
          "Ngoài ra có thể tùy chỉnh bảng điều khiển của bạn bằng CSS, chỉ được đề xuất cho người dùng có kinh nghiệm",
      },
      name: {
        label: "Tên",
      },
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Sau khi hết hạn, lời mời sẽ không còn hiệu lực và người nhận lời mời sẽ không thể tạo tài khoản.",
            },
            copy: {
            ...
            delete: {
              title: "Xóa lời mời",
              description:
                "Bạn có chắc chắn muốn xóa lời mời này không? Người dùng có liên kết này sẽ không thể tạo tài khoản bằng liên kết đó nữa.",
            },
          },
          field: {
            id: {
