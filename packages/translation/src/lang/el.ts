...
import { MRT_Localization_EL } from "mantine-react-table/locales/el/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_EL as Readonly<Record<keyof typeof MRT_Localization_EL, string>>,
  },
  section: {
    category: {
      field: {
  ...
  widget: {
    ...
    iframe: {
      name: "iframe",
      description:
        "Ενσωματώστε οποιοδήποτε περιεχόμενο από το διαδίκτυο. Ορισμένοι ιστότοποι ενδέχεται να περιορίζουν την πρόσβαση.",
      option: {
        embedUrl: {
  ...
  board: {
    ...
    field: {
      ...
      customCss: {
        description:
          "Περαιτέρω, προσαρμόστε τον πίνακα ελέγχου σας χρησιμοποιώντας CSS, συνιστάται μόνο για έμπειρους χρήστες",
      },
      name: {
        label: "Όνομα",
      },
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Μετά τη λήξη, μια πρόσκληση δε θα είναι πλέον έγκυρη και ο παραλήπτης της πρόσκλησης δε θα είναι σε θέση να δημιουργήσει λογαριασμό.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή την πρόσκληση; Οι χρήστες με αυτόν τον σύνδεσμο δεν θα μπορούν πλέον να δημιουργήσουν λογαριασμό χρησιμοποιώντας αυτόν τον σύνδεσμο.",
            },
          },
          field: {
            id: {
