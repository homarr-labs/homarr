...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_UK as Readonly<Record<keyof typeof MRT_Localization_UK, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Після закінчення терміну дії запрошення буде недійсним, і одержувач запрошення не зможе створити обліковий запис.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Ви впевнені, що хочете видалити це запрошення? Користувачі з цим посиланням більше не зможуть створити обліковий запис за цим посиланням.",
            },
          },
          field: {
            id: {
