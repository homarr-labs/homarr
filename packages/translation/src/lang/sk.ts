...
import { MRT_Localization_SK } from "mantine-react-table/locales/sk/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_SK as Readonly<Record<keyof typeof MRT_Localization_SK, string>>,
  },
  section: {
    category: {
      field: {
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Po vypršaní platnosti pozvánky už nebude platná a príjemca pozvánky si nebude môcť vytvoriť účet.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Ste si istí, že chcete túto pozvánku vymazať? Používatelia s týmto odkazom si už nebudú môcť vytvoriť účet pomocou tohto odkazu.",
            },
          },
          field: {
            id: {
