      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Po izteku veljavnosti vabilo ne bo več veljavno in prejemnik vabila ne bo mogel ustvariti računa.",
            },
            copy: {
            ...
            delete: {
              ...
              description:
                "Ali ste prepričani, da želite izbrisati to vabilo? Uporabniki s to povezavo ne bodo mogli več ustvariti računa z uporabo te povezave.",
            },
          },
          field: {
            id: {
