...
import { MRT_Localization_TR } from "mantine-react-table/locales/tr/index.esm.mjs";
...
export default {
  ...
  common: {
    ...
    mantineReactTable: MRT_Localization_TR as Readonly<Record<keyof typeof MRT_Localization_TR, string>>,
  },
  section: {
    category: {
      field: {
  ...
  board: {
    ...
    field: {
      ...
      customCss: {
        description:
          "Ayrıca, yalnızca deneyimli kullanıcılar için önerilen CSS kullanarak kontrol panelinizi özelleştirin",
      },
      name: {
        label: "İsim",
      },
      ...
      user: {
        ...
        invite: {
          ...
          action: {
            new: {
              description:
                "Süre sona erdikten sonra davet artık geçerli olmayacak ve daveti alan kişi bir hesap oluşturamayacaktır.",
            },
            copy: {
            ...
            delete: {
              title: "Daveti sil",
              description:
                "Bu daveti silmek istediğinizden emin misiniz? Bu bağlantıya sahip kullanıcılar artık bu bağlantıyı kullanarak hesap oluşturamayacaktır.",
            },
          },
          field: {
            id: {
