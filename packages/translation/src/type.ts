...
export type ScopedTranslationFunction<NestedKey extends NamespaceKeys<IntlMessages, NestedKeyOf<IntlMessages>> = never> = ReturnType<
  typeof useScopedI18n<NestedKey>
>;
