...
CREATE TABLE `__new_board` (
	...
	`custom_css` text,
	`icon_color` text,
	`item_radius` text DEFAULT 'sm' NOT NULL,
...
INSERT INTO `__new_board`("id", "name", "is_public", "creator_id", "page_title", "meta_title", "logo_image_url", "favicon_image_url", "background_image_url", "background_image_attachment", "background_image_repeat", "background_image_size", "primary_color", "secondary_color", "opacity", "custom_css", "icon_color", "item_radius", "disable_status") SELECT "id", "name", "is_public", "creator_id", "page_title", "meta_title", "logo_image_url", "favicon_image_url", "background_image_url", "background_image_attachment", "background_image_repeat", "background_image_size", "primary_color", "secondary_color", "opacity", "custom_css", "icon_color", "item_radius", "disable_status" FROM `board`;--> statement-breakpoint
