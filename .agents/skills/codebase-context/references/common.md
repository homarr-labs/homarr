...
| Numbers and bytes | `formatNumber`, `formatBytes`, `formatBytesPair`, `formatByteRate`, `formatBitRate`, `metricToImperial`                                              | Compact numbers, byte displays, byte/bit rates, and unit conversion    |
