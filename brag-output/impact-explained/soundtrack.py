...
rate=48000;duration=43;n=rate*duration;samples=array.array('f',[0])*n;rng=random.Random(90218)
...
for start in [7.7,15.7,19.7,24.7,29.7,34.7,39.7]:
 prev=0
...
tone(40.2,.6,523.25,.08);tone(40.42,.6,659.25,.065)
...
out=Path(__file__).parent.parent/'composition/assets/local-captures/impact-score.wav'
