...
for key,orbit in [('impact',False),('orbit',True)]:
 ...
 def panel(name,cls):return f'<div class="panel {cls}"><img src="assets/product/{name}.webp"></div>'
 ...
 scene('advanced',13,5,title('Advanced widget views')+panel('advanced-downloads','advanced')+'<img class="mini mini-one" src="assets/real-widgets/downloads.png"><img class="mini mini-two" src="assets/real-widgets/timer.png"><div class="note">Compact board tiles → detailed views on supported widgets</div>')
 ...
 media='<div class="drag-bg clip" data-start="7" data-duration="6" data-track-index="0"></div><video id="drag-video" class="clip drag-video" src="assets/drag.mp4" data-start="7" data-duration="6" data-track-index="0" muted playsinline></video>'
