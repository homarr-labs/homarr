...
for key,seconds in [('a-release-notes',24),('b-widget-workbench',24),('c-ui-only',18)]:
 ...
 subprocess.run(['ffmpeg','-y','-v','error','-i',str(v),'-vf','fps=1/4,scale=480:-1,tile=3x2','-frames:v','1',str(r/(key+'-review.jpg'))],check=True)
