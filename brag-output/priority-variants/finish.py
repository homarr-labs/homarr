...
for key,seconds in [('a-terse',28),('b-practical',34),('c-technical',40)]:
 ...
 subprocess.run(['ffmpeg','-y','-v','error','-i',str(v),'-vf','fps=1/4,scale=480:-1,tile=5x2','-frames:v','1',str(r/(key+'-review.jpg'))],check=True)
