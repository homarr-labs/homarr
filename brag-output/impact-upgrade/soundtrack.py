...
rate=48000;duration=61;n=rate*duration;samples=array.array('f',[0])*n;rng=random.Random(90218)
...
for start in [7.7,17.6,23.7,31.7,36.7,41.7,46.7,51.7,57.7]:
 prev=0
...
tone(58.2,.6,523.25,.08);tone(58.42,.6,659.25,.065)
...
out=Path(__file__).parent.parent/'composition/assets/upgrade/bed-raw.wav'
