...
segments=[('intro-silent.mp4',0,9),('../impact-stream/workshop-silent.mp4',0,7),('../impact-direct/impact.mp4',16,3460/60),('../impact-fade/widgets-silent.mp4',0,8),('../impact-direct/impact.mp4',4900/60,24),('ending-silent.mp4',0,7)]
assert abs(sum(d for _,_,d in segments)-6760/60)<.001
for timestamp in ('2','4.2','7.2'):
 detail_check=subprocess.run(
  ['ffmpeg','-hide_banner','-ss',timestamp,'-i',str(R/'intro-silent.mp4'),'-frames:v','1','-vf','signalstats,metadata=print:file=-','-f','null','-'],
  capture_output=True,text=True,check=True,
 )
 y_max=re.search(r'lavfi\.signalstats\.YMAX=(\d+)',detail_check.stdout)
 if y_max is None or int(y_max.group(1)) < 100:
  raise RuntimeError(f'Refusing to assemble: intro has no visible detail at {timestamp}s')
...
for t,name in [(7.2,'impact.jpg'),(0,'opening.jpg'),(3.6,'intro-exit.jpg'),(12,'workshop.jpg'),(73+2/3,'widgets-first.jpg'),(74.2,'widgets-entering.jpg'),(77,'widgets.jpg'),(109,'ending.jpg')]:
