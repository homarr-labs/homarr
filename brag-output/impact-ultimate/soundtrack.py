...
for start in [6.7,13.7,25.7,35.7,41.7,49.7,54.7,62.7,68.7,76.7,84.7,89.7,96.7,102.7]:
 prev=0
...
out=Path(__file__).parent.parent/'composition/assets/ultimate/bed-raw.wav'
