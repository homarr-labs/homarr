...
for key,seconds in [('impact',30),('orbit',30)]:
 ...
 subprocess.run(['ffmpeg','-y','-v','error','-i',str(v),'-vf','fps=1/3,scale=480:-1,tile=5x2','-frames:v','1',str(r/(key+'-review.jpg'))],check=True)
