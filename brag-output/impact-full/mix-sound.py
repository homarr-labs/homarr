...
for t in [16.65,20.15,30.75,31.6,35.6,36.3]:cue(t,'pop',.6)
for t in [17.1,21.4,32.15,37,37.6,38.2]:cue(t,'click',.7)
...
with wave.open(str(r/'full-impact/score-raw.wav'),'wb') as f:f.setnchannels(2);f.setsampwidth(2);f.setframerate(rate);f.writeframes(pcm.tobytes())
