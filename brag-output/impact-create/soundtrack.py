...
rate=48000;duration=107;n=rate*duration;samples=array.array('f',[0])*n;rng=random.Random(90218)
...
for start in [6.7,13.7,25.7,37.7,47.7,57.7,63.7,71.7,76.7,84.7,89.7,96.7,102.7]:
 prev=0
...
tone(103.2,.6,523.25,.08);tone(103.42,.6,659.25,.065)
...
out=Path(__file__).parent/'bed-raw.wav'
