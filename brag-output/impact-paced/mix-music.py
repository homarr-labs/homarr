...
rate=48000;duration=7000/60;n=round(rate*duration)
...
filters=f'[0:a]atrim=duration={duration},asetpts=PTS-STARTPTS,loudnorm=I=-21:TP=-4:LRA=8,afade=t=in:d=0.18,afade=t=out:st={duration-4}:d=4[music];[1:a]afade=t=out:st={duration-.7}:d=0.7[fx];[music][fx]amix=inputs=2:duration=first:normalize=0,loudnorm=I=-17:TP=-2.5:LRA=7[a]'
