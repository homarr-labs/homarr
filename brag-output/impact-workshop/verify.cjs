...
const base='http://100.111.30.70:3019/impact-workshop/';
...
for(const scene of ['intro','workshop','integrations','custom','assistant','widgets','statistics','ending']){
 ...
 if(/ultimate (homarr )?update|your metrics|because i.m nice|more data for custom widgets/i.test(result.text)||result.hasHalo)throw Error('Removed material remains in '+scene);
